...
- Scan for domain-related assets:
  ...
  - Existing tests and verification helpers that reduce implementation risk
...
- Note integration surfaces:
  ...
  - App Router entry points, route handlers, server actions, Prisma services, and Supabase helpers
...
This is often the default starting point for this repository when the feature fits an existing route, service, or domain module.
...
- **Brownfield-aware**: Favor reuse of existing project structures before proposing new top-level patterns
