...
- Check whether an existing route handler, server action, service, auth helper, validation schema, or UI module already owns the relevant boundary
...
- Testing focus areas
- Verification expectations using the repository's `pnpm`-based workflow when relevant
