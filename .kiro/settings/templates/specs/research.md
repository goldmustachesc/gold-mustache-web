...
- **Key Findings**:
  ...
  - Finding 2
  - Finding 3
- **Brownfield Context**: note which existing routes, services, auth helpers, validation modules, or UI flows the feature must preserve or extend
...
- ...
- Include relevant internal project references such as steering files, service helpers, validation modules, or route patterns when they materially shaped the design
