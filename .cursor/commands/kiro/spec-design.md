...
3. **Retain Discovery Findings for Step 3**:
   ...
   - Project-specific defaults: Next.js App Router, React 19, Prisma, Supabase, Tailwind, Zod, Biome, Vitest, `pnpm`, and `@/` imports
...
2. **Generate Design Document**:
   ...
   - Prefer extending established route/service/auth/validation patterns before introducing new abstractions or top-level folders
...
- **Project Conventions**: Preserve Biome, Vitest, Prisma/Supabase, and Next.js App Router conventions unless the feature explicitly requires a justified deviation
