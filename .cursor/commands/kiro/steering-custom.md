...
4. **Generate custom steering**:
   ...
   - Align content with existing repository choices such as route handlers under `src/app/api`, Supabase auth/session helpers, Prisma data access, Biome, Vitest, and business domains like agendamento, fidelidade, admin e barbeiro
