...
3. Extract patterns (not lists):
   ...
   - In this repository, prioritize patterns around Next.js App Router, Prisma, Supabase, Tailwind, Biome, Vitest, `pnpm`, `@/` imports, and the booking/loyalty/admin domains
...
- **Project fit**: Prefer brownfield-aligned summaries over aspirational architecture that the codebase does not actually use
