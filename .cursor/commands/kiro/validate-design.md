...
3. **Execute Design Review**:
   ...
   - Pay special attention to alignment with existing Next.js App Router, Prisma, Supabase, Biome, Vitest, and brownfield extension patterns already established in the repository
