...
3. **Execute Gap Analysis**:
   ...
   - Default to brownfield-first analysis in this repository: check whether an existing route, service, auth helper, validation schema, or UI flow can be extended before proposing new top-level patterns
