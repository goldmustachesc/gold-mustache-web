...
- In this repository, prefer the relevant `pnpm` scripts and existing Vitest patterns instead of generic test command assumptions
...
- Validate that implementation also respects established repository conventions (App Router structure, Prisma/Supabase helpers, typed APIs, Biome-friendly organization)
