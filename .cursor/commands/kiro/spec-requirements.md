...
3. **Generate Requirements**:
   ...
   - Prefer domain language aligned with Gold Mustache (cliente, barbeiro, admin, agendamento, fidelidade, perfil, notificações, conteúdo institucional) when relevant
   - Treat the repository as brownfield by default: requirements should respect existing flows and constraints instead of assuming a greenfield implementation
